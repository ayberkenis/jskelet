...
export default {
  ...
  home: {
    ...
    ops: {
      eyebrow: "Görünen ops",
      title: "Redis, yönetim paneli, Cloudflare — ikinci bir ürün eklemeden.",
      lead: "HTML cache süreç belleğinde başlar. Bir anahtar çevirince aynı anahtarlar kopyalar arasında paylaşılır, sertleştirilmiş panel açılır ve edge ile konuşur.",
      tabsLabel: "Bir hikâye seçin",
      stories: [
        {
          id: "redis",
          tab: "Redis L2",
          kicker: "Paylaşılan katman",
          title: "Önce bellek. Ölçeklenince Redis.",
          body: "L1 mikrosaniye HIT için süreç içinde kalır. Redis paylaşılan HTML/data gövdelerini tutar ve invalidateHtmlCache() / clearHtmlCache() çağrılarını pub/sub ile her kopyaya yayar — ioredis isteğe bağlı; yoksa yalnızca L1.",
          facts: [
            { label: "Birincil store", value: "Süreç içi L1" },
            { label: "Paylaşılan gövde", value: "Redis HTML + data" },
            { label: "Yayılım", value: "Pub/sub invalidate" },
          ],
        },
        {
          id: "admin",
          tab: "Yönetim paneli",
          kicker: "/_jskelet/admin",
          title: "Cache, route, view ve canlı log için gerçek bir panel.",
          body: "Overview, Cache, Routes, Views, Logs ve System. Parola her açılışta sunucu loguna düşer, yabancılar 404 alır, botlar varsayılan kapalıdır ve her eylem panel CSRF başlığını ister.",
          facts: [
            { label: "Açmak", value: "admin() veya JSKELET_ADMIN" },
            { label: "Canlı log", value: "Süreç içi SSE" },
            { label: "Gövdeler", value: "Asla dışa verilmez" },
          ],
          nav: ["Overview", "Cache", "Routes", "Views", "Logs", "System"],
          cards: [
            { label: "HTML", value: "128", note: "kayıt · HIT %94" },
            { label: "Redis", value: "açık", note: "paylaşılan · pub/sub" },
            { label: "Prewarm", value: "400", note: "yol / tur" },
            { label: "Upstream", value: "12/s", note: "sınırlayıcı" },
          ],
          logLines: [
            { method: "GET", path: "/haber/piyasalar", cache: "HIT", ms: "2" },
            { method: "GET", path: "/haber/kurlar", cache: "STALE", ms: "4" },
            { method: "PURGE", path: "cf · /haber/*", cache: "OK", ms: "86" },
          ],
        },
        {
          id: "cloudflare",
          tab: "Cloudflare",
          kicker: "Edge bağlantısı",
          title: "Edge'i L1'i temizlediğin yerden temizle.",
          body: "cache().cloudflare zone kimlik bilgilerini bağlar; admin Cache sayfası her şeyi, listedeki URL'leri, bir öneki, host'u veya etiketi purge eder — arıza anında zone ayarlarını da gösterir.",
          facts: [
            { label: "Purge", value: "URL · önek · etiket · host" },
            { label: "Analytics", value: "Sabit 24s pencere" },
            { label: "Aynı panel", value: "Cache → Cloudflare" },
          ],
          steps: [
            { label: "Uygulama", detail: "invalidateHtmlCache" },
            { label: "Redis", detail: "kopyalara yayılım" },
            { label: "Cloudflare", detail: "purgeCloudflare()" },
            { label: "Ziyaretçi", detail: "taze HTML" },
          ],
        },
      ],
    },
